...
namespace MedicoAPI.Controllers
{
    ...
    public class DoctorsController : ControllerBase
    {
        ...
        [HttpGet("Patients")]
        public async Task<ActionResult<List<Counterparts>>> GetPatients(string doctorID)
        {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<DoctorNameID>>> GetAllDoctors()
        {
            return await _context.Doctor.Select(doc =>
                new DoctorNameID
                {
                    ID = doc.DoctorId,
                    Name = doc.DoctorName
...
*//*// ENDSPOITNS THAT ARE NOT NEEDED ANYMORE
